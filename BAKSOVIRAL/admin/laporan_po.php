        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
             ...
             if(isset($_GET['hal']) == 'hapus'){
                ...
                if(mysqli_num_rows($cek) == 0){
                    ...
                    $delete = mysqli_query($koneksi, "DELETE FROM po_terima WHERE id='$id'");
                    if($delete){
            ...
            ?>
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Laporan Purchase Order</li>
                    </ol>
                </section>
           ...
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='laporan_po.php' class="btn btn-sm btn-success" >Refresh</i></a>
            </div>
              </div>
           <!-- /.row -->
                    <br />
                    ...
                    <div class="panel panel-success">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Laporan Purchase Order </h3> 
                        </div>
                  ...
                  <thead>
                    ...
                    <td><center><div id="thanks"><a onclick="return confirm ('Yakin hapus <?php echo $data['kode'];?>?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Produk" href="laporan_po.php?hal=hapus&kd=<?php echo $data['id'];?>"><span class="glyphicon glyphicon-trash"></a>
