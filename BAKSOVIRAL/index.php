      		...
      		<div class="row">
        		...
        		<div class="span4">
					...
					<!--	<p>
						...
						<div class="clear"><a href="detailproduk.php?kd=<?php echo $data['kode'];?>" class="btn btn-lg btn-danger">Detail</a> <a href="detailproduk.php?kd=<?php echo $data['kode'];?>" class="clear"> <a href="login1.php" class="btn btn-lg btn-success">Beli &raquo;</a></div>
					...
					<div class="span6">
						<div class="icons-box-vert">
							...
							<div class="icons-box-vert-info">
								...
								<p>WDelivery order Bakso Viral Jember siap mengirim pesanan anda secara gratis dengan radius maksimal 3 KM</p>
							</div>
							<div class="clear"></div>
						</div>
					</div>
