		...
		while($data = mysqli_fetch_assoc($sql)){
        		...
        		<div class="span4">
					...
					<!--	<p>
						...
						<div class="clear"><a href="detailproduk.php?hal=detailbarang&kd=<?php echo $data['kode'];?>" class="btn btn-lg btn-danger">Detail</a><a href="login1.php" class="btn btn-lg btn-success">Beli &raquo;</a></div>
